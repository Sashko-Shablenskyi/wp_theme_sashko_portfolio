...
<main class="page">
            ...
            <div class="intro__inner">
                <div class="intro__left">
                    ...
                    <div class="intro__title">
                        <h1 class="intro__title-value"><?php echo $general_values['general_name']; ?></h1>
                    ...
                    <div class="intro__btns">
                        <a href="<?php echo $intro_values['intro_btn_download_link'] ?>" class="btn" data-ripple="once"
                            download>
                ...
                <div class="intro__img">
                    ...
                    <div class="decor">
                        <svg xmlns="http://www.w3.org/2000/svg" class="decor__arch">
                            <defs>
                            ...
                            <circle cx="50%" cy="50%" r="43%" fill="none" stroke="url(#borderGradient)"
                                stroke-width="3" />
                            <circle cx="84%" cy="25%" r="15" fill="#000" />
                            <circle cx="88.3%" cy="35%" r="10" fill="#000" />
                        </svg>

                        <a href="#contacts" class="decor__circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140">
                                ...
                                <path id="innerCircle" d="M70 20 A 50 50 0 0 1 70 120 A 50 50 0 0 1 70 20" fill="none">
                                    <animateTransform attributeName="transform" attributeType="XML" type="rotate"
                                        from="0 70 70" to="-360 70 70" dur="15s" repeatCount="indefinite" />
                                </path>
                                <text font-size="14px" fill="white">
                                    <textPath xlink:href="#innerCircle" startOffset="50%" textLength="310"
                                        lengthAdjust="spacingAndGlyphs">
                                        <tspan dy="6" text-anchor="middle">
                                            <?php echo $intro_values['intro_decore_text']; ?> |
                                            <?php echo $intro_values['intro_decore_text']; ?> |
                                        </tspan>
                                    </textPath>
                                    <animateTransform attributeName="transform" attributeType="XML" type="rotate"
    ...
    <section class="about" id="about">
        ...
        <div class="about__container">
            ...
            <div class="about__info info folder" data-watch data-watch-once data-watch-root="about"
                data-watch-threshold=".2">
                <div class="info__box">
                    <span>
                ...
                <div class="info__box">
                    ...
                    <a
                        href="mailto:<?php echo $about_values['about_email']; ?>:"><?php echo $about_values['about_email']; ?></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="portfolio" id="portfolio">
        ...
        <div class="portfolio__container">
            ...
            <div class="portfolio__wrapper">
                <a class="portfolio__project project" href="#" target="_blank"
                    style="background-image: url('img/portfolio/Rectangle.jpg')" data-watch data-watch-once
                    data-watch-root="portfolio" data-watch-threshold=".1">
            ...
            <a class="btn btn--transparent portfolio__btn" href="<?php echo $portfolio_values['portfolio_btn_link'] ?>"
                data-ripple="once" data-watch data-watch-once data-watch-root="portfolio">
    ...
    <section class="statistic" id="statistic">
        ...
        <div class="statistic__container">
            <h2 class="title statistic__title title--inverse" data-watch data-watch-once data-watch-root="statistic"
                data-watch-threshold=".2">
                <?php
            ...
            <div class="statistic__body">
                <div class="statistic__box statistic__box--hidden box" data-watch data-watch-once
                    data-watch-root="statistic" data-watch-threshold=".2">
        ...
        <a class="btn hover btn--inverse statistic__btn" href="https://freelancehunt.com/freelancer/sashko_sh.html"
            target="_blank" data-ripple="once" data-watch data-watch-once data-watch-root="statistic"
            data-watch-threshold=".2">
    ...
    <section class="experience" id="experience">
        <div class="experience__container">
            <h2 class="title experience__title" data-watch data-watch-once data-watch-root="experience"
                data-watch-threshold=".2">
                ...
                <?php
						...
						if ( $skills_query->have_posts() ) {
							while ( $skills_query->have_posts() ) {
								$skills_query->the_post();
								echo '
								<div class="work__box folder" data-watch data-watch-once data-watch-root="experience" data-watch-threshold=".2" data-showmore>
									...
									<button hidden class="work__more" data-showmore-button></button>

									<div class="work__descr" data-showmore-content="0">
    ...
    <section class="contacts" id="contacts">
        ...
        <div class="contacts__container">
            <div class="contacts__left">
                <h2 class="title contacts__title" data-watch data-watch-once data-watch-root="contacts"
                    data-watch-threshold=".2">
                    <?php echo $contacts_values['contacts_title']; ?>
                </h2>
                <div class="contacts__label" data-watch data-watch-once data-watch-root="contacts"
                    data-watch-threshold=".2">
                    <?php echo $general_values['general_name']; ?>
                </div>

                <a href="tel:<?php echo $general_values['general_phone_link']; ?>" class="contacts__tel" data-watch
                    data-watch-once data-watch-root="contacts" data-watch-threshold=".2">
                    <?php echo $general_values['general_phone']; ?>
                </a>

                <div class="contacts__socials" data-watch data-watch-once data-watch-root="contacts"
                    data-watch-threshold=".2">
